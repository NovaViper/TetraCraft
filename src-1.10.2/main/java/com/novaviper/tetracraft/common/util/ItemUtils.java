package com.novaviper.tetracraft.common.util;
...
public class ItemUtils {
	 ...
	 */
	public static Item consumeEquipped(EntityPlayer player, EntityEquipmentSlot hand, Item[] items) {
		ItemStack itemStack = player.getItemStackFromSlot(hand);
	...
	public static boolean consumeEquipped(EntityPlayer player,  EntityEquipmentSlot hand, Item item) {
		return consumeEquipped(player, hand ,new Item[]{item}) != null;
	}
	 ...
	 */
	public static boolean hasEquippedUsable(EntityPlayer player,  EntityEquipmentSlot hand) {
		ItemStack itemStack = player.getItemStackFromSlot(hand);
	 ...
	 */
	public static boolean hasEquipped(EntityPlayer player,  EntityEquipmentSlot hand, Item item) {
		ItemStack itemStack = player.getItemStackFromSlot(hand);
